...
extern int GetUartBase();
extern char IS_MAPPED;
extern volatile unsigned char *	UART_REGS;
/*****************************************************************************
 *
 * NS16550 UART defines.
 * DeviceID starts at 20
 */
#define XPAR_XUARTNS550_NUM_INSTANCES 2         /* Number of instances */

#define XPAR_UARTNS550_0_DEVICE_ID   20         /* Device ID for instance */
#define XPAR_UARTNS550_0_BASEADDR    (0x30000) /* IPIF base address */
//volatile unsigned char * XPAR_UARTNS550_0_BASE    =(UART_REGS)+0x30000; /* IPIF base address */
...
//volatile unsigned char * XPAR_UARTNS550_1_BASE    =(UART_REGS)+0x40000; /* IPIF base address */
#define XPAR_UARTNS550_1_CLOCK_HZ    (100000000L)/* 100 MHz clock */
...
#define XPAR_UARTLITE_0_BASEADDR    0x80020000 /* Device base address */
